...
include("php_action/connection.php"); // connection
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	$mql = "INSERT INTO user(uname,fname,lname,email,password) VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".md5($_POST['password'])."';
	mysqli_query($db, $mql);
                        ...
                        <div class="widget">
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="SUBMIT" name="submit" class="btn theme-btn" a class="nav-link active" href="index.php"></p>
                                    </div>
                                 </div>
                              </form>
